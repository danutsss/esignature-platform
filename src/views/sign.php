...
if(isset($_POST['signOutput'])) {
    ...
    // Insert e-mail into email enqueue.
    $emailQueue = curl_init();

    curl_setopt($emailQueue, CURLOPT_URL, "https://uisp.07internet.ro/crm/api/v1.0/email/1/enqueue");
    curl_setopt($emailQueue, CURLOPT_RETURNTRANSFER, TRUE);
    curl_setopt($emailQueue, CURLOPT_HEADER, FALSE);

    curl_setopt($emailQueue, CURLOPT_POST, TRUE);

    curl_setopt($emailQueue, CURLOPT_POSTFIELDS, "{
    \"to\": \"$contactEmail\",
    \"subject\": \"Contract 07INTERNET - $fullName\",
    \"body\": \"In acest e-mail aveti atasat contractul dumneavoastra semnat cu 07INTERNET.\",
    \"clientId\": $clientId,
    \"attachments\": [
        {
        \"file\": \"$fileEncoding\",
