...
(function ($) {
    function SignaturePad(selector, options) {
        ...
        function stopDrawing(e) {
            if (!!e) {
                ...
                if (
                    output.length > 0 &&
                    settings.onDrawEnd &&
                    typeof settings.onDrawEnd === "function"
                )
        ...
        function drawSigLine() {
            if (!settings.lineWidth) return false;
            ...
            canvasContext.lineTo(
                element.width - settings.lineMargin,
                settings.lineTop
            );
            canvasContext.stroke();
            canvasContext.closePath();
        ...
        function clearCanvas() {
            ...
            if (!settings.displayOnly) drawSigLine();
        ...
        function initDrawEvents(e) {
            ...
            if (typeof e.targetTouches !== "undefined") touchable = true;
        ...
        function type(val) {
            ...
            if (
                typeItNumChars > oldLength &&
                typed.outerWidth() > element.width
            ) {
            ...
            if (
                typeItNumChars < oldLength &&
                typed.outerWidth() + edgeOffset < element.width &&
                typeItCurrentFontSize < typeItDefaultFontSize
            ) {
                while (
                    typed.outerWidth() + edgeOffset < element.width &&
        ...
        function onFormError(errors, context, settings) {
            if (errors.nameInvalid) {
                ...
                $(
                    "label[for=" + $(settings.name).attr("id") + "]",
                    context
        ...
        function validateForm() {
            ...
            if (
                settings.onBeforeValidate &&
                typeof settings.onBeforeValidate === "function"
            ) {
            ...
            if (
                settings.onFormError &&
                typeof settings.onFormError === "function"
            ) {
        ...
        function init() {
            ...
            $(settings.typed, context).bind(
                "selectstart.signaturepad",
                function (e) {
                ...
                if (!settings.displayOnly) {
                    ...
                    if (settings.validateFields) {
                        if ($(selector).is("form")) {
                            ...
                            $(selector)
                                .parents("form")
                                .bind("submit.signaturepad", function () {
                                    return validateForm();
                                });
                        }
                    }
        ...
        $.extend(self, {
            ...
            getSignatureImage: function () {
                ...
                if (
                    ...
                    typeof arguments[0].drawBackground != "undefined"
                )
