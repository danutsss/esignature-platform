    ...
    (function (h, j) {
        ...
        function A() {
            if (j.readyState === "complete") {
                j.detachEvent(F, A);
                for (
                    var a = j.getElementsByTagName(r), b = 0, c = a.length;
                    b < c;
                    ++b
                )
                    B.initElement(a[b]);
        ...
        var T = {
            ...
            B = {
                initElement: function (a) {
                    ...
                    if (j.compatMode === "BackCompat" || !h.XMLHttpRequest)
                        y[b].style.overflow = "hidden";
                    var o = new u(a, d);
                    a.getContext = function (l) {
                        return l === "2d" ? o : k;
                    };
                    a.toDataURL = function (l, z) {
                        ("" + l).replace(/[A-Z]+/g, W) === "image/jpeg"
                            ? o.a.push(
                                  e.toDataURL,
                                  l,
                                  typeof z === "number" ? z : ""
                              )
                            : o.a.push(e.toDataURL, l);
                        return o.e();
                    };
                    d.attachEvent(K, G);
                    return a;
